...
display = Entry(root,bd=29, justify="right" ,bg="powder blue" ,font=("Ariel",20,"bold")).grid(row = 0,rowspan=1,columnspan=4)
#entry5 = Text(root,height=1,width=20,bg="powder blue",font=("Ariel",20),bd=25).grid(row = 0,columnspan=4,rowspan=1)
...
btn_sp= Button(text="+/-",font=("Ariel",12,"bold"),bd=12, height=2, width=6).grid(row=5,column=0)
btn0= Button(text="0",font=("Ariel",12,"bold"),bd=12, height=2, width=6).grid(row=5,column=1)
btn_dot= Button(text=".",font=("Ariel",12,"bold"),bd=12, height=2, width=6).grid(row=5,column=2)
btn_equal= Button(text="=",font=("Ariel",12,"bold"),bd=12, height=2, width=6).grid(row=5,column=3)
